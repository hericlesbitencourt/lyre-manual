...
## Perguntas Abertas para Evolução do App

Para melhorar a aplicação, é importante levantar algumas **perguntas fundamentais**:

- Quais tipos de playlists serão mais usadas?
- O app será usado por uma pessoa, por grupos ou por organizações?
- Teremos níveis de permissão de usuário?
- Quem poderá editar metadados?
- Quem poderá apagar arquivos do servidor?
- O app terá backup automático?
- Será possível desfazer alterações?
- As playlists poderão ser compartilhadas?
- Teremos histórico de alterações?
- O app funcionará apenas online ou também offline?
- Haverá sincronização entre computadores?
- Será possível enviar arquivos manualmente?
- Teremos busca por letra, tags ou categoria?
- Será possível marcar músicas como favoritas?
- Teremos suporte a múltiplas versões da mesma música?

## Resumo

A aplicação é uma **plataforma de streaming e organização** de músicas, vídeos e áudios, com foco em criação de playlists personalizadas.

Ela permite:

- Armazenar arquivos em um servidor
- Organizar conteúdos por artista e álbum
- Editar metadados
- Evitar duplicações
- Configurar pontos específicos de início e fim para cada mídia

Além disso, pode se integrar com **serviços externos** para buscar metadados ou importar referências de músicas, mas algumas dessas funcionalidades dependem de plataformas e bibliotecas externas, o que pode gerar limitações ou necessidade de manutenção futura.

Em resumo, o app funciona como uma **biblioteca multimídia inteligente**, voltada para facilitar a criação de playlists mais precisas, organizadas e adaptadas a diferentes contextos de uso.
